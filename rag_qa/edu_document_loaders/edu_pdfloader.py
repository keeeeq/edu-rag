...
if __name__ == '__main__':
    # pdf_loader = OCRPDFLoader(file_path=r"D:\workspace\workspace_python\python_1022\dev07_rag\integrated_qa_system\rag_qa\data\samples\ocr_03.pdf")
    pdf_loader = OCRPDFLoader(file_path=r"D:\workspace\workspace_python\python_1022\dev07_rag\integrated_qa_system\rag_qa\data\samples\AI大模型开发（Python）就业学习大纲.pdf")
    doc = pdf_loader.load()
